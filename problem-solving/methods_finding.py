...
for method_name in built_in_methods:
    if ends_with_ed(method) == True:
        methods.append(method_name)
# methods = filter(ends_with_ed, built_in_methods)
